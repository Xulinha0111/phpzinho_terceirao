...
<body>
    <div class="container">
        ...
        <?php
          if(isset($_POST["acessar"])) { //isset verifica se o botão de acessar foi clickado
            $usuario    = $_POST["usuario"];
            $senha      = $_POST["senha"];

            require "conexao.php"; //importa os dados da conexão com os banco de dados
            ...
            if($resultado == 0) {
                ...
                echo "<p class='text-center text-danger'> Usuário ou Senha inválidos! </p>";
            }
          }
        ?>
        <p class="text-center text-info">Não está cadastrado? - <a href='CriarUsuario.php'>Clique aqui para Cadastar Usuário</a></p>;
    </div>
</body>
</html>